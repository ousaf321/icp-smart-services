...
function ToolkitService(onOpenCB, onCloseCB, onErrorCB, options) {
    ...
    if (options.CONFIRM_TEXT_WINDOWS)
        this.CONFIRM_TEXT_WINDOWS = options.CONFIRM_TEXT_WINDOWS;
    else
        ...
        if ('Windows' === deviceType) {
            ...
            if (true == result) {
                ...
                if (navigator.userAgent.indexOf("WOW64") != -1 ||
                    ...
                    window.location.href = "../../scripts/ICAToolkitSetup_64.rar";
                } else {
                    window.location.href = "../../scripts/ICAToolkitSetup_32.rar";
                }
            } else {
    ...
    var initializeWS = function () {
        try {
            ...
            //LOG("ToolkitService :: web socket URL"+ secure + wsUrl);
