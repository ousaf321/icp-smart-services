...
angular.module('ivh.treeview').provider('ivhTreeviewOptions', function () {
    ...
    var options = {
         ...
         */
        twistieExpandedTpl: '<span class="btn btn-default btn-xs"><i class="fa fa-minus"></i><span>',

        /**
         * Template for collapsed twisties
         */
        twistieCollapsedTpl: '<span class="btn btn-info btn-xs"><i class="fa fa-plus"></i></span>',
        ...
        nodeTpl: [
            ...
            '</span>',
            '{{trvw.label(node)}}',
            '<span class="ivh-treeview-node-label" ng-if="node.children == null" ivh-treeview-toggle>',
            '{{node.id.split("_")[1]}}', 
            '</span>',
